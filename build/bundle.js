...
var UnicornForm = React.createClass({displayName: "UnicornForm",
  ...
  render: function() {
    return (
      React.createElement("form", {onSubmit: this.handleSubmit}, 
        React.createElement("label", {htmlFor: "newunicorn"}, "New Unicorn "), 
        React.createElement("input", {id: "newunicorn", type: "text", value: this.state.newUnicorn.unicornBody, onChange: this.handleChange}), 
        React.createElement("button", {type: "submit"}, "Create New Unicorn")
      )
    )
  }
});

var Unicorn = React.createClass({displayName: "Unicorn",
  render: function() {
    return React.createElement("li", null, this.props.data.unicornBody)
  }
}); 

var UnicornList = React.createClass({displayName: "UnicornList",
  render: function() {
    var unicorns = this.props.data.map(function(unicorn) {
      return React.createElement(Unicorn, {data: unicorn, key: unicorn._id})
    });
    return (
      React.createElement("section", null, 
        React.createElement("h1", null, "Unicorns:"), 
...
var UnicornApp = React.createClass({displayName: "UnicornApp",
  getInitialState: function() {
    return {unicornData: []};
  },
  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement(UnicornForm, {onNewUnicornSubmit: this.onNewUnicorn, url: this.props.unicornBaseUrl}), 
        React.createElement(UnicornList, {data: this.state.unicornData})
      )
    )
  }
});

React.render(React.createElement(UnicornApp, {unicornBaseUrl: 'api/v1/unicorns'}), document.body);
